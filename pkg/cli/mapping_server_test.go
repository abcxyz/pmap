	...
	cases := []struct {
		...
		},
		{
			...
			env: map[string]string{
				...
				"PMAP_MAPPING_RESOURCE_SCOPE": "projects/pmap-ci",
			},
		...
		},
		{
			...
			env: map[string]string{
				...
				"PMAP_SUCCESS_TOPIC_ID":       "test_success_topic",
				"PMAP_FAILURE_TOPIC_ID":       "test_failure_topic",
				"PMAP_MAPPING_RESOURCE_SCOPE": "foo/bar",
			},
			expErr: `invalid mapping configuration: PMAP_MAPPING_RESOURCE_SCOPE: foo/bar doesn't have a valid value`,
		},
		{
			...
			expErr: `invalid mapping configuration: PMAP_MAPPING_RESOURCE_SCOPE is empty`,
		},
		{
